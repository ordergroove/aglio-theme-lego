...
(function() {
  ...
  decorate = function(api, md, slugCache, verbose) {
    var action, category, dataStructure, dataStructures, err, example, i, item, j, k, knownParams, len, len1, len2, name, newParams, param, ref, ref1, ref2, resource, resourceGroup, results, reversed, schema, slugify;
    ...
    ref2 = api.resourceGroups || [];
    results = [];
    for (k = 0, len2 = ref2.length; k < len2; k++) {
      resourceGroup = ref2[k];
      ...
      results.push((function() {
        ...
        for (l = 0, len3 = ref3.length; l < len3; l++) {
          ...
          results1.push((function() {
            var len4, len5, m, n, ref4, results2;
            ref4 = resource.actions || [];
            results2 = [];
            for (m = 0, len4 = ref4.length; m < len4; m++) {
              ...
              for (n = 0, len5 = reversed.length; n < len5; n++) {
                param = reversed[n];
              ...
              results2.push((function() {
                var len6, o, ref5, results3;
                ref5 = action.examples || [];
                results3 = [];
                for (o = 0, len6 = ref5.length; o < len6; o++) {
                  example = ref5[o];
                  results3.push((function() {
                    var len7, p, ref6, results4;
                    ref6 = ['requests', 'responses'];
                    results4 = [];
                    for (p = 0, len7 = ref6.length; p < len7; p++) {
                      name = ref6[p];
                      results4.push((function() {
                        var len10, len11, len12, len8, len9, q, r, ref10, ref11, ref7, ref8, ref9, results5, s, t, u;
                        ref7 = example[name] || [];
                        results5 = [];
